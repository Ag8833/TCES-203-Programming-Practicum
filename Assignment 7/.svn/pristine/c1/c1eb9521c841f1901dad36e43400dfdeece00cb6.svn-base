...
Node<string>* listCreate(List<string>*);//Function prototype to create a list.
void listProcess(List<string>*);//Function prototype to delete nodes and print the list.
void listDelete(List<string>*, Node<string>*);//Function prototype to delete dynamically allocated memory.

void stackTesting();//Function prototype to test the stack class.
Node<string>* stackCreate(Stack<string>*);//Function prototype to create a stack.
void stackProcess(Stack<string>*);//Function prototype to delete nodes and print the stack.
void stackDelete(Stack<string>*, Node<string>*);//Function prototype to delete dynamically allocated memory.

void queueTesting();//Function prototype to test the queue class.
Node<string>* queueCreate(Queue<string>*);//Function prototype to create a queue.
void queueProcess(Queue<string>*);//Function prototype to delete nodes and print the queue.
void queueDelete(Queue<string>*, Node<string>*);//Function prototype to delete dynamically allocated memory.
...
void nodeTesting()
{
	...
	Node<string>* firstNode = new Node<string>("Andrew");
...
void listTesting()
{
	...
	Node<string>* nodeArray = listCreate(myList);
...
Node<string>* listCreate(List<string>* myList)
{
	//Allocating my 4 nodes for testing.
	Node<string>* nodeArray = new Node<string>[MAXSIZE];
...
void listProcess(List<string>* myList)
{
	try
	{
		...
		//Attempting to remove another node to catch the error message.
		cout << endl;
		myList->removeFirst();
	}
...
void listDelete(List<string>* myList, Node<string>* nodeArray)
{
	delete myList;
	delete [] nodeArray;
}
...
void stackTesting()
{
	...
	Node<string>* nodeArray = stackCreate(myStack);
...
Node<string>* stackCreate(Stack<string>* myStack)
{
	//Allocating my 4 nodes for testing.
	Node<string>* nodeArray = new Node<string>[MAXSIZE];
	nodeArray[0].setNodeName("Andrew");
...
void stackProcess(Stack<string>* myStack)
{
	try
	{
		...
		//Attempting to pop another node to catch the error message.
		cout << endl;
		myStack->popStack();
	}
...
//Function definition to delete dynamically allocated memory.
void stackDelete(Stack<string>* myStack, Node<string>* nodeArray)
{
	delete myStack;
	delete [] nodeArray;
}
...
void queueTesting()
{
	...
	Node<string>* nodeArray = queueCreate(myQueue);
...
Node<string>* queueCreate(Queue<string>* myQueue)
{
	//Allocating my 4 nodes for testing.
	Node<string>* nodeArray = new Node<string>[MAXSIZE];
	nodeArray[0].setNodeName("Andrew");
...
void queueProcess(Queue<string>* myQueue)
{
	try
	{
		...
		//Attempting to dequeue another node to catch the error message.
		cout << endl;
		myQueue->deQueue();
	}
...
//Function definition to delete dynamically allocated memory.
void queueDelete(Queue<string>* myQueue, Node<string>* nodeArray)
{
	delete myQueue;
	delete [] nodeArray;
}
